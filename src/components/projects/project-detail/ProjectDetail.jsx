...
const projects = [
    {
        ...
        overview: '본 프로젝트는 개인 일정 관리와 팀 단위 협업 기능을 통합 제공하여, 사용자 간 효율적인 정보 공유와 업무 조율을 지원하는 협업 플랫폼입니다.<br/>DBMS_CRYPTO를 활용한 개인정보 암호화, 권한 분리, 접근 로그 관리 등 보안 요소를 설계 초기부터 반영하였고, Spring Security와 JWT 기반 인증/인가 체계를 구축하였습니다. 또한 GitHub Actions를 통한 CI/CD 자동화와 AWS 인프라 환경에의 안정적인 배포를 통해 실사용 환경을 고려한 구조를 구현하였습니다.',
        features: [
